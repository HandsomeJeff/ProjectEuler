...
"""
alist=[]
for x in range(3, len(inp)-2):
        if inp[x] == inp[x].lower() and inp[x+1] == inp[x+1].upper() and inp[x+2] == inp[x+2].upper() and inp[x-1] == inp[x-1].upper() and inp[x-2] == inp[x-2].upper() and inp[x-3] == inp[x-3].upper() and inp[x+3] == inp[x+3].upper() and inp[x-4] == inp[x-4].lower() and inp[x+4] == inp[x+4].lower():
            alist.append(inp[x-3:x+4])
